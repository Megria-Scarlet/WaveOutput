...
{
    public class OutputOptionViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        protected System.Windows.Input.ICommand openSamplePresetFileCommand;
        public System.Windows.Input.ICommand OpenSamplePresetFileCommand
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => openSamplePresetFileCommand;
        }
        protected System.Windows.Input.ICommand reloadSamplePresetFileCommand;
        public System.Windows.Input.ICommand ReloadSamplePresetFileCommand
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => reloadSamplePresetFileCommand;
        }
        ...
        #region コンストラクタ
        public OutputOptionViewModel() : this(SamplePreset.GetDefaultSamplePreset())
        {

        }
        public OutputOptionViewModel(IEnumerable<SamplePresetValue> samples, int sampleIndex)
        {
            this.samples = samples;
            this.sampleIndex = sampleIndex;
            this.openSamplePresetFileCommand = new OpenFileCommand(this);
            this.reloadSamplePresetFileCommand = new ReloadFileCommand(this);
        }
        public OutputOptionViewModel(SamplePreset preset) : this(preset.Samples, preset.DefaultSampleIndex)
        {
        ...
        {
            NotifyPropertyChanged(nameof(OpenSamplePresetFileCommand));
        }
        ...
        public virtual string GetSamplePresetFilePath() => string.Empty;
        ...
        protected class OpenFileCommand : System.Windows.Input.ICommand
        {
            public OutputOptionViewModel outputOption;
            public event EventHandler? CanExecuteChanged;

            public OpenFileCommand(OutputOptionViewModel outputOption)
            {
                this.outputOption = outputOption;
            }

            public bool CanExecute(object? parameter) => System.IO.File.Exists(outputOption.GetSamplePresetFilePath());
            public void Execute(object? parameter) => outputOption.OpenSamplePresetFile();
        }
        protected class ReloadFileCommand : System.Windows.Input.ICommand
        {
            public OutputOptionViewModel outputOption;
            public event EventHandler? CanExecuteChanged;
            public ReloadFileCommand(OutputOptionViewModel outputOption)
            {
                this.outputOption = outputOption;
            }
            public bool CanExecute(object? parameter) => true;
            public void Execute(object? parameter) => outputOption.ReloadSamplePresetFile();
        }
    }

    public class StaticWaveOutputOption : OutputOptionViewModel
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override string GetSamplePresetFilePath() => Resource.wavePresetFilePath;
    ...
    public class StaticMp3OutputOption : OutputOptionViewModel
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override string GetSamplePresetFilePath() => Resource.mp3PresetFilePath;
        public override void OpenSamplePresetFile()
        {
    ...
    public class BitsAndChannel : IEquatable<BitsAndChannel>, System.Numerics.IEqualityOperators<BitsAndChannel, BitsAndChannel, bool>
    {
        protected int bits;
        ...
        public static bool operator ==(BitsAndChannel? left, BitsAndChannel? right) => EqualityComparer<BitsAndChannel>.Default.Equals(left, right);
